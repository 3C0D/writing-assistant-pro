...
### UI Modulaire (Implémenté)

L'architecture UI a été refondue pour utiliser un **Design System** centralisé et des composants réutilisables :

- `src/ui/design_system.py` : Source unique de vérité pour le style.
- `src/ui/components/` : Composants isolés et testables.
- `src/ui/app.py` : Allégé, agit comme un coordinateur.
