...
def copy_required_files(target_dir: str) -> bool:
    """
    Copy required files for build to the specified target directory.

    Args:
        target_dir: Target directory name (e.g., 'production')
    """
    ...
    print(f"Copying required files to dist/{target_dir}/...")
...
# PyInstaller exclusions for NiceGUI/pywebview projects
